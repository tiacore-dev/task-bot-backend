...
class Task(Model):
    ...
    creator = fields.ForeignKeyField(
        "diff_models.User", related_name="tasks_created")
    platform = fields.ForeignKeyField(
        "diff_models.TaskPlatform", related_name="tasks")
    task_type = fields.ForeignKeyField(
        "diff_models.TaskType", related_name="tasks")
    ...
    status = fields.ForeignKeyField(
        "diff_models.TaskStatus", related_name="tasks")
...
class TaskAssignment(Model):
    ...
    task = fields.ForeignKeyField(
        "diff_models.Task", related_name="assignments")
...
class Transaction(Model):
    ...
    user = fields.ForeignKeyField(
        "diff_models.User", related_name="transactions")
...
class UserActivityLog(Model):
    ...
    user = fields.ForeignKeyField(
        "diff_models.User", related_name="activity_logs")
